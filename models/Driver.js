...
Driver.add({
	...
	imgUrl: { type: Types.CloudinaryImage, publicID: 'dritgo', label:"Avatar", folder: 'images/drivers/'},
    bgImgUrl: { type: Types.CloudinaryImage, publicID: 'dritgo', label: "Background", folder: 'images/drivers/'},
